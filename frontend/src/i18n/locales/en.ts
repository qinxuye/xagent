    ...
    logs: {
      event: {
        ...
        actions: {
          ...
          react_task_failed: "ReAct Task Failed",
          ...
          workforce_delegation_start: "Agent Delegation Start",
          workforce_delegation_end: "Agent Delegation Completed",
          workforce_delegation_error: "Agent Delegation Failed",
        },
        messages: {
